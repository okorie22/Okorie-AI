...
PORTFOLIO_RESET_ENABLED = False  # Set to False to prevent portfolio reset issues
...
PRICE_SOURCE_MODE = "jupiter"  # Options: "birdeye", "jupiter" - Switched to Jupiter due to Birdeye API issues
...
DRAWDOWN_LIMIT_PERCENT = -0.11  # 10% maximum drawdown
...
EMERGENCY_STOP_CRITICAL_LOSS_THRESHOLD = -15  # Close positions with >15% loss immediately
...
# Wallet tracking
WALLETS_TO_TRACK = [
    "EHg5YkU2SZBTvuT87rUsvxArGp3HLeye1fXaSDfuMyaf",  # tilcrypto (Score: 0.278)
    "4DdrfiDHpmx55i4SPssxVzS9ZaKLb8qr45NKY9Er9nNh",  # TheMisterFrog (Score: 0.274)
]
...
6. WHALE_DATA: Top-performing whale wallet insights and market trends
...
2. Then explain your reasoning, including:
   ...
   - Whale wallet performance trends consideration
   - Recent execution success patterns
...
- Whale wallet performance trends can indicate institutional sentiment and market timing
