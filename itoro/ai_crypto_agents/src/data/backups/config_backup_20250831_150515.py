...
# Wallet tracking
WALLETS_TO_TRACK = [
    "8CRGEUBcBztAUgd61VY7ss3eW17R7HVvnvhtjKB5Y4G4",  # None (Score: 0.881)
    "CChcZtUXCv7CDp6vq9Zto6oqG4eE1nbHGh8AwA4ZRfnC",  # None (Score: 0.319)
]
...
CHART_INITIAL_DELAY_HOURS = 1  # Wait 1 hour before first analysis
TIMEFRAMES = ['4h']
...
print(f"Auto-detected webhook host: {WEBHOOK_HOST}")
