...
def print_agent_dashboard():
    ...
    # Agent configurations from config (removed staking agent)
    agents = {
        'copybot': {
            'name': 'CopyBot Agent',
            'emoji': '🤖',
...
def initialize_agents():
    ...
    global copybot_agent, risk_agent, harvesting_agent
    ...
    try:
        ...
        print_initialization_progress(1, 4, "Initializing CopyBot Agent...")
        ...
        print_initialization_progress(2, 4, "Initializing Risk Agent...")
        time.sleep(0.5)  # Visual delay for effect
        ...
        print_initialization_progress(3, 4, "Initializing Harvesting Agent...")
        time.sleep(0.5)  # Visual delay for effect
        ...
        # Step 4: Check for startup rebalancing
        print_initialization_progress(4, 4, "Checking for startup rebalancing...")
        time.sleep(0.5)  # Visual delay for effect
        print()  # Ensure clean line break
