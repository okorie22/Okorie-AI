...
class ReviewAgent:
    ...
    def __init__(self, pipeline_manager,
        ...
        Args:
            ...
            review_email: Email address to send reviews to
            timeout_hours: Hours before auto-rejecting
            imap_host: Optional IMAP host for checking responses (e.g., 'imap.gmail.com')
        """
