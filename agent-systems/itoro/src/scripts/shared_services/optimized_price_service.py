...
try:
    ...
    # Secondary fallback must still use absolute 'src.' to avoid bare top-level mis-imports
    from src.scripts.shared_services.logger import debug, info, warning, error
    import src.config as config
    from src.nice_funcs import get_birdeye_api_key
...
class OptimizedPriceService:
    ...
    def __init__(self):
        ...
        self.quicknode_rpc = config.QUICKNODE_RPC_ENDPOINT
        self.quicknode_wss = config.QUICKNODE_WSS_ENDPOINT
