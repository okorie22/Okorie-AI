...
def get_token_decimals_accurate(token_address: str) -> int:
    ...
    try:
        ...
        try:
            from src.scripts.token_metadata_service import TokenMetadataService
...
def market_sell(QUOTE_TOKEN, amount, slippage, allow_excluded: bool = False, agent: str = "unknown"):
    ...
    """
    from src.scripts.utilities.error_handler import safe_execute, TradingExecutionError
    ...
    try:
        ...
        try:
            ...
            try:
                from src.scripts.data_processing.token_decimals_helper import to_token_units
        ...
        try:
            ...
            if QUOTE_TOKEN == "So11111111111111111111111111111111111111112":  # SOL
                ...
                try:
                    from src.scripts.data_processing.token_decimals_helper import get_token_decimals
...
def _get_jupiter_price(token_address):
    ...
    try:
        ...
        try:
            import json
            import os
            memory_file = 'src/data/artificial_memory_d.json'
...
def market_entry(symbol, amount, slippage=200, allow_excluded: bool = False, agent: str = "market_entry"):
    ...
    try:
        ...
        from src.config import EXCLUDED_TOKENS, PAPER_TRADING_ENABLED
...
def chunk_kill(token_address, pct_each_chunk=30):
    ...
    try:
        ...
        if PAPER_TRADING_ENABLED:
            from src.paper_trading import execute_paper_trade, get_paper_portfolio
...
def market_buy(token, amount, slippage, allow_excluded: bool = False):
    ...
    try:
        from src.scripts.trading.position_validator import validate_usdc_balance
