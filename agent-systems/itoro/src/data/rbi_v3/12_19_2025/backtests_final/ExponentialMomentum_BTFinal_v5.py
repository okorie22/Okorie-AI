...
if 'datetime' in price_data.columns:
    ...
    for col in price_data.columns:
        if 'time' in col or 'date' in col:
            ...
            print(f"[INFO] Using column '{col}' as datetime index")
            break
...
class ExponentialMomentum(Strategy):
    ...
    def next(self):
        ...
        if self.position:
            ...
            holding_period = current_idx - self.trades[-1].entry_bar
        ...
        # Check entry conditions (only if not in position)
            ...
            if entry_condition1 and entry_condition2 and entry_condition3:
                ...
                if stop_distance > 0:
                    ...
                    print(f"[BUY] Equity: {self.equity:.2f}, Risk amount: {risk_amount:.2f}")
                ...
                # Debug: Print why entry conditions failed
                if current_idx % 100 == 0:
                    print(f"[DEBUG] Entry conditions failed at bar {current_idx}: "
                          f"cond1={entry_condition1}, cond2={entry_condition2}, cond3={entry_condition3}")
