...
def create_dashboard_text(agent, last_check_time, next_check_time, cycle_count, alert_count):
    ...
    lines.append("┌──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┐")
    lines.append("│  Symbol  │      Status      │  Last Activity  │   Long Liq    │  Short Liq   │ Events │  Total USD   │")
    lines.append("├──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┤")
    ...
    for symbol in symbols:
        ...
        lines.append(f"│ {icons[symbol]} {symbol:<6} │  {status:<14}  │   {activity:<11}   │  ${longs:>10,.2f} │ ${shorts:>10,.2f} │  {total_events:>4}  │ ${total_usd:>10,.2f} │")
    ...
    lines.append(f"│  Last Check: {last_str}  │  Next Check: {next_str}  │  Cycles: {cycle_count:<3}  │  Alerts: {alert_count:<3}  │  Interval: {config.LIQUIDATION_CHECK_INTERVAL}s  │")
    lines.append("└──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┘")
    lines.append("")
