...
from scripts.shared_services.logger import debug, info, warning, error, critical
from scripts.shared_services.shared_api_manager import get_shared_api_manager
from scripts.shared_services.optimized_price_service import get_optimized_price_service
import config
...
class SharedDataCoordinator:
    ...
    def _fetch_token_data(self, token_address: str) -> Optional[TokenData]:
        ...
        """
        try:
            from scripts.data_processing.token_metadata_service import get_token_metadata_service
