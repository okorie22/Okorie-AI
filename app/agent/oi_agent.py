...
from scripts.oi.oi_storage import OIStorage
from scripts.oi.oi_analytics import OIAnalytics
from scripts.shared_services.redis_event_bus import get_event_bus
from scripts.shared_services.alert_system import MarketAlert, AlertType, AlertSeverity
import traceback
...
try:
    from nice_funcs_hl import get_funding_rates as hl_get_funding_rates, get_24h_volume as hl_get_24h_volume
